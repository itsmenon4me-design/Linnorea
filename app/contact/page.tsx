...
export default async function ContactPage() {
  ...
  return (
    <main className="bg-[var(--color-bg-base)] text-white">
      ...
      <ScrollReveal as="section" className="mx-auto grid max-w-7xl gap-12 px-5 py-20 md:grid-cols-[0.55fr_1.45fr] md:gap-20 md:px-8 md:py-28" aria-labelledby="project-inquiry">
        <div data-reveal>
